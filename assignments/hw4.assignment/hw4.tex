...
\item Write a function, preferably in Python/Sage, though other languages will do, with the following specifications:
	...
	\fbox{\begin{minipage}{.9\textwidth}
	\textbf{Description:} Finds all integer solutions to $y^2=x^3+ax+b$ such that $xmin \leq x\leq xmax$ and $ymin\leq y\leq ymax$.
	
	\textbf{Input:} Six integers $a,b,xmin,xmax,ymin,ymax$.
	
	\textbf{Output:} A list of all solutions to $y^2=x^3+ax+b$ such that $xmin \leq x\leq xmax$ and $ymin\leq y\leq ymax$.
